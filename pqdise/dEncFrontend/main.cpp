...
int main(int argc, char** argv)
{
    ...
    std::string shSym("ss"), shAsym("sa"), shSymLWR("sl"), malAsym("ma"), pvAsym("pv");
    bool noneSet = !cmd.isSet(shSym) && !cmd.isSet(shAsym) && !cmd.isSet(malAsym) && !cmd.isSet(pvAsym) && !cmd.isSet(shSymLWR);
    if (noneSet)
    {
        std::cout
            << "============================================\n"
